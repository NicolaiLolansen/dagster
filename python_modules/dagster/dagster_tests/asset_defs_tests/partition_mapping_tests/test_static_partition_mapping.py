...
def test_single_valued_static_mapping():
    ...
    assert result.partitions_subset == DefaultPartitionsSubset({"p", "r"})
    ...
    assert result.partitions_subset.partitions_subset == DefaultPartitionsSubset({"p1", "p2", "p3"})
...
def test_multi_valued_static_mapping():
    ...
    assert result.partitions_subset.partitions_subset == DefaultPartitionsSubset({"p", "q1", "q2"})
